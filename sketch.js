...
function setup() {
	...
	bottomBody = Bodies.rectangle (width/2 , 650,150,35, {isStatic:true} );
	 World.add (world , log1);

	leftBody = Bodies.rectangle (300 , 600,10,150, {isStatic:true} );
	 World.add (world , log1);

    rightBody= Bodies.rectangle ( 150, 600,10,150, {isStatic:true} );
	 World.add (world , log1);
